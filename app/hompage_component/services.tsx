  ...
  return (
    <div className=" md:px-12 px-4">
      <div className="max-w-7xl  mx-auto pt-16 bg-[#fffff0]">
        ...
        <div className="grid grid-cols-1 w-full  sm:grid-cols-3 gap-6 pt-6">
          {services.map((service, index) => (
            ...
            >
              ...
              >
                <div
                  className={`w-10 h-10 rounded-md flex items-center justify-center text-xl font-semibold mb-2 ${
                    service.active
                      ? "bg-white/10 text-white"
                      : "bg-blue-50 text-blue-600"
                  }`}
