...
//         <div className="flex flex-col gap-[] w-full max-w-7xl mx-auto">
//            <p className="font-mediumtext-[16px] text-[#10A4EA] tracking-[1.6px] ">HOW WE WORK</p>
//            <p className="font-medium text-[40px] text-[#031F4F] w-[612px] leading-tight ">A Process Built Around Clarity and Collaboration.</p>
//            <p className="font-semibold text-[16px] text-[#7B899A] ">From strategy to delivery, every step is intentional and transparent.</p>
//         </div>
//     </div>
//   )
// }
